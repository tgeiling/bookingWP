...
class BCBSBookingStatus
{
	...
	function __construct()
	{
		...
		(
			1=>array(__('Pending (new)','boat-charter-booking-system')),
			2=>array(__('Processing (accepted)','boat-charter-booking-system')),
			3=>array(__('Cancelled (rejected)','boat-charter-booking-system')),
			4=>array(__('Completed (finished)','boat-charter-booking-system')),
			5=>array(__('On hold','boat-charter-booking-system')),
			6=>array(__('Refunded','boat-charter-booking-system')),	
			7=>array(__('Failed','boat-charter-booking-system'))
		);		
		...
		(
			1=>array(__('No synchronization','boat-charter-booking-system')),
			2=>array(__('One way: from wooCommerce to plugin','boat-charter-booking-system')),
			3=>array(__('One way: from plugin to wooCommerce','boat-charter-booking-system'))
		);
	}
